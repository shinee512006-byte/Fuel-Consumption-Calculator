...
public class Fuel {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            String carType1 = input.nextLine();

            System.out.print("Enter start km: ");
            int startKms1 = input.nextInt();

            System.out.print("Enter end km: ");
            int endKms1 = input.nextInt();

            System.out.print("Enter liters filled: ");
            double liters1 = input.nextDouble();

            System.out.print("Enter price per liter: ");
            double pricePerLiter1 = input.nextDouble();
            input.nextLine();

            cars[i] = new Fuel(carType1, endKms1, startKms1, liters1, pricePerLiter1);
        }
        ...
        for (int i = 0; i < n; i++) {
            ...
            System.out.printf(Locale.ENGLISH, "%-15s %-11d %-9d %-8d %-7.2f %-5.2f %-5.2f %-10.2f %.4f%n",
